...
→ Đề xuất: hiển thị dưới dạng "Điểm khích lệ riêng của lớp" **tách biệt** trên hồ sơ học sinh, không cộng vào công thức xếp loại thi đua chính thức ở mục 4, để không làm lệch số liệu khi đối chiếu với trường. Anh xác nhận có muốn bật tính năng này ở Giai đoạn 1 hay để Giai đoạn 2.
