        ...
        <section className="rounded-lg border border-teal-200 bg-teal-100 p-4">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h3 className="text-base font-bold text-slate-900">Đề xuất ghi nhận từ ban cán sự lớp</h3>
              <p className="text-sm text-slate-600">
                Học sinh được cấp quyền gửi đề xuất ghi nhận qua link hồ sơ. Duyệt để tạo ghi nhận thật, hoặc từ
                chối nếu không đúng.
              </p>
            </div>
