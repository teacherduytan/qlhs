                      ...
                      {student ? (
                        <div className="flex shrink-0 gap-2">
                          ...
                          <button
                            ...
                            className="h-9 shrink-0 rounded-md border border-red-200 bg-white px-3 text-xs font-semibold text-red-700 hover:bg-red-100 disabled:cursor-not-allowed disabled:text-slate-400"
                          >
                            Xoá
                          </button>
                        </div>
              ...
              <div key={item.id} className="flex flex-col gap-3 rounded-md border border-orange-100 bg-white p-3">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="h-10 rounded-md border border-red-200 bg-white px-4 text-sm font-semibold text-red-700 hover:bg-red-100 disabled:cursor-not-allowed disabled:text-slate-400"
                  >
                    Xoá
                  </button>
                </div>
